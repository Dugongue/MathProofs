...
b=Path(__file__).resolve().parent;u=b/'baseline';c=b/'candidate'
import os,shutil
...
flags += ['-D'+p+'_'+f+'_simd='+p+'_'+f for p in ['base','fast'] for f in ['pmod_mat_mul','crypto_sign_keypair','crypto_sign','crypto_sign_open']]
